...
public class SecurityConfig {
    ...
    private String[] authorizationRequireAdminNonIdempotentPostRequest = {
            ...
            "/api/v1/cart/removeFromCart",
            "/api/v1/cart/updateTheCart",
    };
    @Autowired
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize->
                        authorize
                                .requestMatchers("/swagger-ui*/**","v3/api-docs/**","/api/v1/cart/hello").permitAll()
                                .requestMatchers(HttpMethod.POST, authorizationRequireAdminNonIdempotentPostRequest).permitAll()
